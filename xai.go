...
// GenParams is used to build the parameters for a generation request. It provides
// methods for setting various parameters such as the system prompt, input messages,
// tools, and generation parameters like `max_tokens`, `temperature`, etc. The
